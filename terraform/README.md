...
This guide describes how to use Terraform to deploy your extension app to AWS cloud provider:
...
1. **Navigate to the directory of the AWS cloud provider you want to deploy to:**
    ```sh
    cd aws
    ```
