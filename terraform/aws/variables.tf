...
variable "application_name" {
  ...
  type        = string
  nullable    = false
  default     = "jpm-account-opening-implementation"
...
variable "application_build_labels" {
  ...
  type        = map(string)
  default = {
    "org.opencontainers.image.title"       = "Docusign and JPMorgan Account Opening Implementation"
    "org.opencontainers.image.description" = "This joint use case between Docusign and JPMorgan Chase demonstrates how financial institutions can modernize the account opening experience by combining workflow orchestration, identity validation, and agreement execution into a single, streamlined process."
    "org.opencontainers.image.source"      = "https://github.com/docusign/docusign-jpmorgan-account-opening-implementation"
